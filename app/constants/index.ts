...
export const user={name:'Brian May'}
export const dashboardStats = {
  totalUsers: 12450,
  usersJoined: { currentMonth: 218, lastMonth: 176 }, // +23.9% → green
  totalTrips: 3210,
  tripsCreated: { currentMonth: 59, lastMonth: 98 },  // -40% → red
  userRole: { total: 62, currentMonth: 25, lastMonth: 15 } // +66.7% → green
};
